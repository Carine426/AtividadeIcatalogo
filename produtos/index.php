                    ...
                    <section>
                        ...
                        <span class="categoria">
                            ...
                            <?php 
                                if(isset($_SESSION["usuarioId"])   ){
                            ?>
                            <img class="imagem-produto" onclick="javascript: window.location = './editar/index.php?id=<?=$produto['id'] ?>'" src="/aularafael/projetophp/icatalogo-parte1/imgs/editar-arquivo.png" />
